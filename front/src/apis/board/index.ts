...
import { GET_BOARD_LIST_URL, GET_BOARD_URL, GET_SEARCH_BOARD_LIST_URL, INCREASE_VIEW_COUNL_URL, POST_BOARD_REQUEST_URL, POST_COMMENT_REQUEST_URL } from 'src/constant';
